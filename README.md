# Almabetter - Capstone project  - BookMyShow
...
Frontend on netlify.com
 [- bookmyshowgoursunder.netlify.app](https://bookmyshowgoursunder.netlify.app/)
...
bash
 git clone (https://github.com/goursunderpandey/bookmyshow1.git)
